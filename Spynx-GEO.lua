...
function init_gear_sets()
  ...
  sets.midcast.Geomancy = {
    ...
    back = "Lifestream Cape", --	13
    waist = "Austerity Belt +1", --			9
    feet = "Medium's Sabots" --	5		6
    -- Totals						940
  }
  ...
  sets.midcast['Elemental Magic'] = {
    ...
    head = gear.Merl_nuke_head, neck = "Sanctity Necklace", ear1 = "Malignance Earring", ear2 = "Regal Earring",
    body = gear.Amal_nuke_body, hands = gear.Amal_nuke_hands, ring1 = gear.ElementalRing, ring2 = "Freke Ring",
