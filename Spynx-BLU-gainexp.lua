...
function init_gear_sets()
    ...
    sets.idle = {
		...
		body="Jhakri Robe +2", hands=gear.Herc_Ref_hands, ring1="Defending Ring", ring2="Dark Ring",
		back="Moonbeam Cape", waist="Flume Belt +1", legs="Carmine Cuisses +1",	feet=gear.Herc_Ref_feet
	}
